...
if(screen.width<=480){
    var words=["PROGRAMACION", "COMPUTADORA", "LENGUAJE","ORACLE","DISEÑO","DESARROLADOR","MOTOCICLETA","AUTOMOVIL","ARGENTINA","MARADONA","TECLADO"];    var board= document.getElementById("draw-mobile").getContext("2d");
    var lettersUsed = [];
    var correctLetters="";
    var lives=7;
    var point=0
